...
//평가점수 관련 변수
int my_con[8] = { 0, 0, 0, 1, 3, 5, 1000, -1000 };      //연속된 돌
...
void main()
{
	...
	while (input == 0) {
		...
		*/
		...
		int temp_put;
		//printf("temp : (temp돌로 놓으려면 1을 입력하세요, 직접입력시 다른키를 입력하세요)"); 
		//scanf_s("%d", &temp_put);
		printf("\n");
